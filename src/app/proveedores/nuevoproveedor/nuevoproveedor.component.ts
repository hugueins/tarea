...
ngOnInit(): void {
  ...
  if (this.idProveedores>0){
    this.provedorService.uno(this.idProveedores).subscribe((proveedor)=> {
  ...
  if (this.idProveedores==0 || isNaN(this.idProveedores)) {
    this.provedorService.insertar(iproveedor).subscribe((respuesta)=> {
  ...
  if (parseInt (respuesta) > 1 ){
   ...
   iproveedor.idProveedores=this.idProveedores;
    this.provedorService.actualizar(iproveedor).subscribe((respuesta)=>{
